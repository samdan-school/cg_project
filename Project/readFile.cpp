...
bool ReadFromFile(const char *path, vector<vector<float>> &vertices,
    ...
    while (1) {
        ...
        if (strcmp(lineHeader, "v") == 0) {
            ...
            temp.push_back(abs(a1));
            temp.push_back(abs(a2));
            temp.push_back(abs(a3));
            temp.push_back(abs(b1));
            temp.push_back(abs(b2));
            temp.push_back(abs(b3));
            temp.push_back(abs(c1));
            temp.push_back(abs(c2));
            temp.push_back(abs(c3));
            temp.push_back(abs(d1));
            temp.push_back(abs(d2));
            temp.push_back(abs(d3));
